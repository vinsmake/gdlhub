...
export const FollowsPage = () => {
  ...
  return (
    <div className="space-y-6 p-6">
      <h1 className="text-3xl font-bold text-white text-center">Actividad de usuarios que sigues</h1>

      {feed.length === 0 ? (
        <p className="text-gray-300 text-center">No hay actividad reciente aún.</p>
      ) : (
